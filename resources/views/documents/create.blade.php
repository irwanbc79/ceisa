    ...
    <script>
        function documentWizard() {
            return {
                ...
                // Real Bea Cukai Reference Codes
                references: {
                    countries: [
                        { code: 'ID', label: 'ID - Indonesia' },
                        { code: 'SG', label: 'SG - Singapura' },
                        { code: 'JP', label: 'JP - Jepang' },
                        { code: 'CN', label: 'CN - Cina' },
                        { code: 'US', label: 'US - Amerika Serikat' },
                        { code: 'MY', label: 'MY - Malaysia' },
                        { code: 'KR', label: 'KR - Korea Selatan' },
                        { code: 'DE', label: 'DE - Jerman' },
                        { code: 'AU', label: 'AU - Australia' }
                    ],
                    ports: [
                        { code: 'IDJKT', label: 'IDJKT - Tanjung Priok, Jakarta' },
                        { code: 'IDSUB', label: 'IDSUB - Tanjung Perak, Surabaya' },
                        { code: 'IDSRG', label: 'IDSRG - Tanjung Emas, Semarang' },
                        { code: 'IDTPP', label: 'IDTPP - KPU Tanjung Priok, Jakarta' },
                        { code: 'IDBMS', label: 'IDBMS - Belawan, Medan' },
                        { code: 'IDTJP', label: 'IDTJP - Tanjung Pelepas' },
                        { code: 'SGSIN', label: 'SGSIN - Singapore Port' },
                        { code: 'JPTYO', label: 'JPTYO - Tokyo Port' },
                        { code: 'CNSZN', label: 'CNSZN - Shenzhen Port' },
                        { code: 'USLAX', label: 'USLAX - Los Angeles' }
                    ],
                    currencies: [
                    ...
                    paymentMethods: [
                        { code: 'Tunai', label: 'Tunai / Cash' },
                        { code: 'Kredit', label: 'Kredit' },
                        { code: 'L/C', label: 'L/C (Letter of Credit)' },
                        { code: 'Telegraphic Transfer (TT)', label: 'Telegraphic Transfer (TT)' },
                        { code: 'Open Account', label: 'Open Account' },
                        { code: 'Konsinyasi', label: 'Konsinyasi' }
                    ],
                    units: [
                        { code: 'PCE', label: 'PCE - Piece / Buah' },
                        { code: 'KGM', label: 'KGM - Kilogram' },
                        { code: 'UNT', label: 'UNT - Unit' },
                        { code: 'BOX', label: 'BOX - Box / Kotak' },
                        { code: 'TNE', label: 'TNE - Ton' },
                        { code: 'LTR', label: 'LTR - Liter' },
                        { code: 'MTR', label: 'MTR - Meter' },
                        { code: 'VIA', label: 'VIA - Vial' }
                    ],
                    packages: [
                        { code: 'BX', label: 'BX - Box' },
                        { code: 'CT', label: 'CT - Carton / Kardus' },
                        { code: 'PL', label: 'PL - Pallet' },
                        { code: 'PK', label: 'PK - Package' },
                        { code: 'CO', label: 'CO - Colli / Bag' },
                        { code: 'DR', label: 'DR - Drum' }
                    ],
                    tpbTypes: [
                        { code: 'Kawasan Berikat (KB)', label: 'Kawasan Berikat (KB)' },
                        { code: 'Gudang Berikat (GB)', label: 'Gudang Berikat (GB)' },
                        { code: 'Pusat Logistik Berikat (PLB)', label: 'Pusat Logistik Berikat (PLB)' },
                        { code: 'Toko Bebas Bea (TBB)', label: 'Toko Bebas Bea (TBB)' }
                    ],
                    tpbDestinations: [
                        { code: 'Pengeluaran Hasil Produksi ke TLDDP (BC 2.5)', label: 'Pengeluaran ke TLDDP (BC 2.5)' },
